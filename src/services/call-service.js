...
class CallService {
  ...
  get currentUser() {
    console.log("get currentUser", store.getState());
  ...
  async startCall(usersIds, callType, options = {}) {
    ...
    console.log("startCall session", session);
    ...
    console.log("startCall streams", streams);
  ...
  async _onCallListener(session, extension) {
    ...
    console.log("[CallService][dispatch]", session);
